...
\paragraph{N.B.:} \textbf{Siete tenuti a conoscere la precisione macchina della singola e doppia precisione.}
...
\paragraph{4.} Questo fenomeno è la manifestazione del malcondizionamento della somma algebrica