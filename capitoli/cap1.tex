...
Il "problema" da studiare e' il condizionamento della somma algebrica
\begin{equation}\label{eq:problema_condizionamento_somma_algebrica}
	y=x_1+x_2\neq 0,\quad x_1,x_2\in\mathbb R,
\end{equation}
dove $x_1,\, x_2$ sono gli addendi esatti ed $y$ la soluzione esatta (quindi per il problema (\ref{eq:problema}) $f(x) = x_1 + x_2$).
