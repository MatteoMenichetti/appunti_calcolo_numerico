...
\begin{enumerate}
   ...
   \end{definition}
	...
	\begin{definition}[Formula di Simpson]
...
\paragraph{Implementazione:} Vedere l'Algoritmo \ref{alg:trapec} e Algoritmo \ref{alg:trapec_vettoriale}.
...
\begin{algorithm}
	...
	\begin{lstlisting}[style=Matlab-editor]
		...
		x = linspace(a, b, n+1);
		h = (b-a)/n;
		f = feval(fun, x); %alternativa: f = feval(fun, (0:n)*h);
