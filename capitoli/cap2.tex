...
Il metodo di Aitken è preferibile al metodo di Newton in quanto Newton converge linearmente verso radici multiple con molteplicità ignota, mentre il metodo di Aitken converge quadraticamente verso radici multiple con molteplicità ignota. Tale metodo utilizza una procedura a due livelli (basata sul metodo di Newton):
\begin{enumerate}
