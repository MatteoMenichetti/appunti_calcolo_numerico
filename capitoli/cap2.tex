...
\paragraph{NOTA BENE:} I criteri d'arresto \ref{eq:critArrConvMag1} e \ref{eq:criterio_arresto_newton} sono entrambi validi, ma è preferibile utilizzare \ref{eq:critArrConvMag1} perché questo assume una connotazione di errore.
