...
\paragraph{N.B:} $[\min\{\underset{i}{\min}\,x_i,\,x\},\, \max\{\underset{i}{\max}\,x_i,\, x\}]$ e' più piccolo intervallo contenente le ascisse in argomento alla differenza divisa in (\ref{eq:errore_interpolazione_forma_newton}).
...
Quindi $s_1(x)$ è la spezzata che congiunge i punti in coordinate $(x_{i-1},f_{i-1})$ e $(x_i,f_i)$ per $i=0,\hdots, n$. Questo sarà utile quando saranno calcolate spline diverse dalle lineari.
