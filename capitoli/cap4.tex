...
\begin{theorem}[Esistenza ed Unicità del polinomio interpolante]\label{th:esistenza_unicita_polinomio_interpolante}\footnote{Slide 2 PDF 15, TH 4.1 PG 78}
    Date $n+1$ ascisse distinte del tipo (\ref{eq:ascisse_interpolazione}),
    \begin{equation*}
...
\begin{remark}
	...
	\end{equation*}
	dove $p(x)$ è il polinomio interpolante di $f(x)$ sulle ascisse assegnate. Inoltre, è utile ribadire che le rappresentazioni del polinomio interpolante (\ref{eq:polinomio_interpolante_generico}) e (\ref{eq:polinomio_interpolante_forma_lagrange}) sono algebricamente uguali, quindi segue che: 
...
%riniziare da pagina 3 CN2025-03-06
