...
Nel caso in cui siano fornite gia' le differenze divise allorapossibile eliminare dall'Algoritmo \ref{alg:metodo_horner_modificato} la riga dove sono calcolate. Inoltre,possibile osservare che l'ascissa di interpolazione $n+1$-esima (vettore $x$ dell'Algoritmo) puo' non essere considerata perche' per calcolare la funzione di base di Newton l'ultima ascissa non utile. Per questo, verificare che $f$ e $x$ abbiano la stessa lunghezza significa condiderare $f-1$.
