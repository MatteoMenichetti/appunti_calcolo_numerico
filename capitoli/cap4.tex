...
Nel caso in cui è ricercata la soluzione del polinomio in forma di Newton (ovvero di \ref{eq:polinomio_interpolante_newton}, il quale è riportato)
\begin{equation*}
...
\end{equation*}
Quindi (\ref{eq:polinomio_interpolante_newton}) diventa
\begin{equation*}
...
\noindent Pertanto, il $p(x)$ assume la seguente forma \osmnfj
\begin{equation*}
	p(x) & = & 
\end{equation*} 
...
\begin{remark}[Costo dell'Algoritmo \ref{alg:polinomio_horner_modificato}]
