...
\begin{remark}[Condizione necessaria esistenza fattorizzazione $LU$]\label{rem:condizione_necessaria_fattorizzazione_LU}
...
\begin{theorem}\label{th:matrice_diagonale_dominante_nonsingolare}\footnote{Slide 5 PDF 5, Lemma 3.9 PG 55.}
    $A$ \textit{d.d.} (per righe o per colonne) $\Rightarrow A$ nonsingolare ($\rightarrow A$ e' fattorizzabile $LU$).
\end{theorem}
\begin{proof}
