...
È esaminato il caso in cui le ipotesi Teorema \ref{th:esistenza_fattorizzazione_LU} di esistenza della fattorizzazione $LU$ non sono soddisfatte, anche se $A$ è nonsingonale. Quindi è esaminato il caso in cuila fattorizzazione $LU$ non esiste. È possibile modificare la fattorizzazione $LU$, in modo da definire una nuova matrice che soddisfi le ipotesi del Teorema \ref{th:esistenza_fattorizzazione_LU}.
