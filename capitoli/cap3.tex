...
\begin{proof}
    \begin{itemize}
        ...
        Fissato un generico $i\in\{1,\hdots, n\},\, \exists!\, \uline x\in\mathbb R^n\backslash\{\uline 0\}:\boldsymbol{L^T\uline x=\uline e_i}$, l'$i$-esimo versore di $\mathbb R^n.$  Essendo $L$ \gls{nonsingolare}, è evidente che $\uline x \neq \uline 0$.
